...
export const UserInfoPage = () => {
  ...
  const saveChanges = async () => {
    ...
    try {
      ...
      // If the request was successful, we'll update the token
      // in local storage and show a success message
      setToken(response.data.token);
      setShowSuccessMessage(true);
    } catch (error) {
      // If the request failed, we'll show an error message
  ...
  return (
    <div className="content-container">
      ...
      {!isVerified && (
        <div className="fail">
          You won't be able to update your info until you verify your email
        </div>
      )}
      {showSuccessMessage && (
